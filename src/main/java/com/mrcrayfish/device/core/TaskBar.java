...
public class TaskBar
{
	...
	private static final int APPS_DISPLAYED = MrCrayfishDeviceMod.DEVELOPER_MODE ? 18 : 100;
	...
	public void init(int posX, int posY)
	{
		...
		btnLeft.xPosition = posX + 95;
		btnLeft.yPosition = posY ;
		...
		btnRight.xPosition = posX + 45 + 2 * APPS_DISPLAYED + 14;
		btnRight.yPosition = posY ;
	...
	public void render(Laptop gui, Minecraft mc, int x, int y, int mouseX, int mouseY, float partialTicks)
	{
		...
		// bar
		RenderUtil.drawRectWithTexture(123, y - 2, 1, 0, Laptop.SCREEN_WIDTH - 182, 20, 1, 18);
		
		
		// Top Bar
		RenderUtil.drawRectWithTexture(x - 94, 35, 1, 0, Laptop.SCREEN_WIDTH, 14, 1, 18);
		...
		mc.fontRendererObj.drawString(timeToString(mc.player.world.getWorldTime()), x + 240, 38, Color.WHITE.getRGB(), true);
