...
import net.husky.device.api.app.Icon;
...
import net.husky.device.programs.bluej.AddFileDialog;
import net.husky.device.programs.bluej.Project;
import net.husky.device.programs.bluej.ProjectFile;
import net.husky.device.programs.bluej.components.BlueJCodeEditor;
import net.husky.device.programs.bluej.resources.BlueJResourceLocation;
...
//		rightPanelWidth = 0;
	...
	private void archiveProjectHandler(Component c, int button) {
		...
		SaveFile file = new SaveFile(this, new File("", "idemodthingy:dynamicapp", tag));
