...
public class Tile
{
	...
	public static final Tile planks_spruce = new TileBlock(7, 3, 1).setCategory(Category.BLOCKS);
	public static final Tile planks_jungle = new TileBlock(7, 3, 1).setCategory(Category.BLOCKS);
	public static final Tile planks_birch = new TileBlock(7, 3, 1).setCategory(Category.BLOCKS);
	public static final Tile planks_big_oak = new TileBlock(7, 3, 1).setCategory(Category.BLOCKS);
	public static final Tile planks_acacia = new TileBlock(7, 3, 1).setCategory(Category.BLOCKS);
	...
	public static final Tile netherwart_block = new TileBlock(10, 7, 1).setCategory(Category.BLOCKS);
	public static final Tile netherbricks = new TileBlock(10, 7, 1).setCategory(Category.BLOCKS);
	public static final Tile red_netherbricks = new TileBlock(10, 7, 1).setCategory(Category.BLOCKS);
