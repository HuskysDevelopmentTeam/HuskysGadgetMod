...
public enum Icon
{
    ...
    SORT,
    FONT,
    CHEVRON_LIGHT_GRAY_RIGHT,
    CHEVRON_LIGHT_GRAY_DOWN,
    CHEVRON_LIGHT_GRAY_UP,
    CHEVRON_LIGHT_GRAY_LEFT,
    CHEVRON_DARK_GRAY_RIGHT,
    CHEVRON_DARK_GRAY_DOWN,
    CHEVRON_DARK_GRAY_UP,
    CHEVRON_DARK_GRAY_LEFT,
    CHEVRON_BLACK_RIGHT,
    CHEVRON_BLACK_DOWN,
    CHEVRON_BLACK_UP,
    CHEVRON_BLACK_LEFT;

    public static final ResourceLocation ICON_ASSET = new ResourceLocation(Reference.MOD_ID, "textures/gui/icons.png");
