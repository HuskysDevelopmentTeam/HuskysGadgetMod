package net.husky.device.api.io;
...
import net.husky.device.core.io.action.FileAction;
import net.husky.device.core.io.task.TaskGetFiles;
...
public class Folder extends File
{
	 ...
	 * {@link net.husky.device.core.io.FileSystem.Response} indicating if the file was
	 ...
	 * return a {@link net.husky.device.core.io.FileSystem.Response} indicating if the file was
	 * successfully added to the folder or an error occurred.
	 *
	 * @param file the file to add
	 ...
	 * , and will return a {@link net.husky.device.core.io.FileSystem.Response} indicating if
