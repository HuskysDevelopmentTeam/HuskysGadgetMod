...
import net.thegaminghuskymc.gadgetmod.tileentity.TileEntityMechanicalKeyboard;
...
public class BlockMechanicalKeyboard extends BlockDevice implements ITileEntityProvider {

    public BlockMechanicalKeyboard() {
        super(Material.ANVIL);
        this.setCreativeTab(HuskyGadgetMod.deviceDecoration);
        this.setUnlocalizedName("mechanical_keyboard");
        this.setRegistryName(Reference.MOD_ID, "mechanical_keyboard");
    }

    @Nullable
    @Override
    public TileEntity createNewTileEntity(World worldIn, int meta) {
        return new TileEntityMechanicalKeyboard();
    }
