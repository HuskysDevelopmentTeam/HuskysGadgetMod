...
public class BlockElectricSecurityGate extends BlockFacing {
    ...
    private static final AxisAlignedBB BOUNDING_BOX = new AxisAlignedBB(0.5625, 0.0, 0.4375, 1.0, 1.0, 0.5625);

    private static final AxisAlignedBB COLLISION_BOX = new Bounds(0, 0, 7.5, 16, 32, 8.5).toAABB();

    private DamageSource electricFence = new DamageSourceFence("electricGate");

    public BlockElectricSecurityGate() {
        super(Material.IRON, Reference.MOD_ID, "electric_gate");
