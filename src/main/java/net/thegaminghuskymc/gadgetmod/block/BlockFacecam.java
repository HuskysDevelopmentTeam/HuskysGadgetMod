...
public class BlockFacecam extends BlockHorizontal /*implements ITileEntityProvider*/ {

    public BlockFacecam() {
        super(Material.ANVIL);
        this.setCreativeTab(HuskyGadgetMod.deviceBlocks);
        this.setUnlocalizedName("face_camera");
        this.setRegistryName(Reference.MOD_ID, "face_camera");
    }
    ...
    public void breakBlock(World worldIn, BlockPos pos, IBlockState state) {
        ...
        if (tileEntity instanceof TileEntityDesktop) {
            ...
            tileEntityTag.removeTag("recording");
