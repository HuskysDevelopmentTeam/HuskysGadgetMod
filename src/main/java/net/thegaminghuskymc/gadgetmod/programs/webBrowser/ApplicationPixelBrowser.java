package net.thegaminghuskymc.gadgetmod.programs.webBrowser;
...
public class ApplicationPixelBrowser extends Application {
    ...
    private PixelBrowserFrame webFrame;
    ...
    public void init(@Nullable NBTTagCompound intent) {
        layoutBrowser = new StandardLayout("Pixel Browser", 362, 240, this, null);
        ...
        webFrame = new PixelBrowserFrame(this, 0, 21, 362, 143);
