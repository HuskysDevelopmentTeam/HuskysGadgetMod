...
import net.thegaminghuskymc.gadgetmod.programs.webBrowser.module.Module;
import net.thegaminghuskymc.gadgetmod.programs.webBrowser.module.ModuleEntry;
 ...
 * Author: MrCrayfish
 */
public class PixelBrowserFrame extends Component {
...
//        MODULES.put("download", new DownloadModule());
    ...
    public PixelBrowserFrame(Application app, int left, int top, int width, int height) {
        super(left, top);
        this.app = app;
        this.width = width;
        this.height = height;
    ...
    private void setWebsite(String website) {
        ...
        Matcher matcher = PixelBrowserFrame.PATTERN_LINK.matcher(website);
        if (!matcher.matches()) {
