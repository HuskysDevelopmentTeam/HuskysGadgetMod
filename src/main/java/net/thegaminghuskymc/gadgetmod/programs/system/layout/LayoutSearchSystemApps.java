 ...
 * Author: MrCrayfish
 */
public class LayoutSearchSystemApps extends StandardLayout
{
    ...
    public LayoutSearchSystemApps(ApplicationAppStore appStore, Layout previous)
    {
    ...
    public void init()
    {
        ...
        itemListResults.setItems(ApplicationManager.getSystemApplications());
        ...
        textFieldSearch.setKeyListener(c ->
        {
            ...
            List<AppInfo> filteredItems = ApplicationManager.getSystemApplications().stream().filter(FILTERED).collect(Collectors.toList());
