    ...
    public void init() {
		...
		apps.setItemClickListener((info, index, mouseButton) ->
		{
            if(apps.getSelectedIndex() == 0) {
                if(mouseButton == 0) {
                    this.setCurrentLayout(new LayoutAppPage(ApplicationManager.getApplication("hgm:bank")));
                }
            } else if(apps.getSelectedIndex() == 1) {
                if(mouseButton == 0) {
                    this.setCurrentLayout(new LayoutAppPage(ApplicationManager.getApplication("hgm:pixel_book")));
                }
            } else if(apps.getSelectedIndex() == 2) {
                if(mouseButton == 0) {
                    this.setCurrentLayout(new LayoutAppPage(ApplicationManager.getApplication("hgm:cackler")));
                }
            }
        });
