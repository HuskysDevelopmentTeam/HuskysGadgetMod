...
public class ApplicationAppStore extends Application {
    private static final ResourceLocation BANNER = new ResourceLocation(Reference.MOD_ID, "textures/app/app_store_banner.png");

    private Layout layoutHome;
    private net.thegaminghuskymc.gadgetmod.api.app.component.Image imageBanner;
    private net.thegaminghuskymc.gadgetmod.api.app.component.Label labelBanner;
    private net.thegaminghuskymc.gadgetmod.api.app.component.Label labelCategories;
    ...
    public void init() {
        ...
        imageBanner = new net.thegaminghuskymc.gadgetmod.api.app.component.Image(0, 0, 250, 50, "https://i.imgur.com/VAGCpKY.jpg");
        layoutHome.addComponent(imageBanner);

        labelBanner = new net.thegaminghuskymc.gadgetmod.api.app.component.Label("App Market", 10, 42);
