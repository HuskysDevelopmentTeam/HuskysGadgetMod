 ...
 * {@link net.thegaminghuskymc.gadgetmod.api.task.Task} from the client to the server. It is not possible to
 * do this from the client side alone.
 * <p>
 * If a notification is needed to be produced on the client side only, see
 * {@link net.thegaminghuskymc.gadgetmod.core.client.ClientNotification}
 */
