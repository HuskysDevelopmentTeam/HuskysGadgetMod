...
public class RenderUtil {
    ...
    public static void drawApplicationBanner(@Nullable AppInfo info, double x, double y) {
        Minecraft.getMinecraft().getTextureManager().bindTexture(Laptop.BANNER_TEXTURES);
        if (info != null) {
            drawRectWithTexture(x, y, info.getBannerU(), info.getBannerV(), 250, 40, 250, 40, 500, 160);
        } else {
            drawRectWithTexture(x, y, 0, 0, 250, 40, 250, 40, 500, 160);
        }
    }
