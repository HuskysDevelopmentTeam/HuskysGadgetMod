...
public class GadgetCrafting
{
	public static void register()
	{
		...
		for(EnumDyeColor colour : EnumDyeColor.values()) {
            GameRegistry.addShapedRecipe(new ResourceLocation("laptops"), new ResourceLocation("gadgets"), new ItemStack(GadgetBlocks.LAPTOP, 1, colour.getMetadata()), "XYX", "YXY", "XYX", 'X', Items.REDSTONE, 'Y', Items.IRON_INGOT);
        }
	}
}
