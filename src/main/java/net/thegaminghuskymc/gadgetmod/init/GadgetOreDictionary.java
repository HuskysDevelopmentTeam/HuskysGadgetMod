...
public class GadgetOreDictionary {
    ...
    public static void init() {
        ...
        IntStream.range(0, EnumDyeColor.values().length).forEach(meta -> registerWithHandlers("playstation4ProGadget" + StringUtils.capitalize(EnumDyeColor.values()[meta].getName()),
                new ItemStack(GadgetBlocks.PLAYSTATION_4_PRO, 1, meta)));
        ...
        IntStream.range(0, EnumDyeColor.values().length).forEach(meta -> registerWithHandlers("externalHarddriveGadget" + StringUtils.capitalize(EnumDyeColor.values()[meta].getName()),
                new ItemStack(GadgetBlocks.EXTERNAL_HARDDRIVE, 1, meta)));
		/*IntStream.range(0, EnumDyeColor.values().length).forEach(meta -> registerWithHandlers("internalHarddriveGadget" + StringUtils.capitalize(EnumDyeColor.values()[meta].getName()),
				new ItemStack(GadgetItems.internal_harddrive, 1, meta)));*/
