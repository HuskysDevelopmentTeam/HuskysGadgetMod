 ...
 * Author: MrCrayfish
 */
public class ItemExternalHarddrive extends Item implements SubItems {

    public ItemExternalHarddrive() {
        this.setUnlocalizedName("external_harddrive");
        this.setRegistryName(Reference.MOD_ID, "external_harddrive");
