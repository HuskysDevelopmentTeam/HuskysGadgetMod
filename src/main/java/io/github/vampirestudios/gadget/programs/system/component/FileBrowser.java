...
import io.github.vampirestudios.gadget.api.app.listener.ItemClickListener;
...
import io.github.vampirestudios.gadget.core.io.task.TaskGetStructure;
...
public class FileBrowser extends Component {
     ...
     * from {@link Application#init(NBTTagCompound)} and pass them into the
