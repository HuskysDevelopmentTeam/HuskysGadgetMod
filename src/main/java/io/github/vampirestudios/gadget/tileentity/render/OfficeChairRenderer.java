...
import io.github.vampirestudios.gadget.block.BlockOfficeChair;
...
public class OfficeChairRenderer extends TileEntitySpecialRenderer<TileEntityOfficeChair> {
    ...
    public void render(TileEntityOfficeChair te, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
        ...
        GlStateManager.pushMatrix();
        {
            ...
            IBlockState state = tempState.getBlock().getDefaultState().withProperty(BlockOfficeChair.FACING, EnumFacing.NORTH).withProperty(BlockOfficeChair.TYPE, BlockOfficeChair.Type.SEAT);
