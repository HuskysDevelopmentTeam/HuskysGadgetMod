...
public class BlockColored extends Block implements IBlockColorProvider {
    ...
    public BlockColored(String name, EnumDyeColor color) {
        super(Material.ROCK);
        this.color = color;
        this.setTranslationKey(Reference.MOD_ID + "." + name + "_" + color.getName());
        this.setRegistryName(new ResourceLocation(Reference.MOD_ID, name + "_" + color.getName()));
    }
