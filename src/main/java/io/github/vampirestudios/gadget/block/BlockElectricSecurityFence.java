...
import io.github.vampirestudios.gadget.DamageSourceFence;
import io.github.vampirestudios.gadget.Reference;
import io.github.vampirestudios.gadget.init.GadgetSounds;
...
public class BlockElectricSecurityFence extends Block {
    ...
    public BlockElectricSecurityFence() {
        ...
        this.setRegistryName(new ResourceLocation(Reference.MOD_ID, "electric_fence"));
