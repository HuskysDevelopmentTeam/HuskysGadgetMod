...
import io.github.vampirestudios.gadget.tileentity.TileEntityExternalHarddrive;
...
public class BlockExternalHarddrive extends BlockColoredDevice {
    ...
    public IBlockState getStateForPlacement(World world, BlockPos pos, EnumFacing facing, float hitX, float hitY, float hitZ, int meta, EntityLivingBase placer, EnumHand hand) {
        ...
        return state.withProperty(FACING, placer.getHorizontalFacing()).withProperty(VERTICAL, facing.getIndex() != -1);
    }
