...
import io.github.vampirestudios.gadget.object.Picture.Size;
import io.github.vampirestudios.gadget.object.tools.*;
...
public class Canvas extends Component {
    ...
    public static final Tool BLUR = new ToolBlur();
    public static final Tool MAGIC_WAND = new ToolMagicWand();
    public static final Tool MOVE = new ToolMove();
    public static final Tool PEN = new ToolPen();
    public static final Tool SMUDGE = new ToolSmudge();
    public int[] pixels;
